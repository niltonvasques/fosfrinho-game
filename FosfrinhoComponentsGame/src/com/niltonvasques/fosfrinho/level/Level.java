...
//	}
	...
	public Array<GameObject> getDrawableBlocks(int xCenter, int yCenter, int width, int height){
		int x = xCenter - width;
		int y = yCenter - height;
		if(x < 0) x = 0;
		if(y < 0) y = 0;
		...
		if(y2 > getHeight())
			y2 = getHeight() - 1;
		Array<GameObject> blocks = new Array<GameObject>();
